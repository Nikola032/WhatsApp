...
public class WhatsAppChat extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            firstUserChatQuery.whereEqualTo("waTargetReceipient", selectedUser);

            secondUserChatQuery.whereEqualTo("waSender", selectedUser);
            secondUserChatQuery.whereEqualTo("waTargetReceipient", ParseUser.getCurrentUser().getUsername());
    ...
    public void onClick(View view) {
        ...
        chat.put("waTargetReceipient",selectedUser);
